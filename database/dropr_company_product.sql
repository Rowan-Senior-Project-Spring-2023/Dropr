...
CREATE TABLE `company_product` (
  ...
  CONSTRAINT `company_product_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `company` (`company_id`),
  CONSTRAINT `company_product_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
...
-- Dump completed on 2023-03-01  9:31:35
